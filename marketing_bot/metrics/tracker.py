...
class MetricsTracker:
    ...
    async def track_campaign_execution(
        ...
        logger.info(f"Tracked execution: campaign={campaign_id}, customer={customer_id}, success={success}")
    ...
    async def get_campaign_metrics(self, campaign_id: UUID) -> dict:
        ...
        successful_executions = len([m for m in campaign_metrics if m.get("success", False)])
