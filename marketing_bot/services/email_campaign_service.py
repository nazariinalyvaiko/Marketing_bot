...
from marketing_bot.database.email_database import EmailDatabase, EmailContact
...
class EmailCampaignService:
    ...
    async def send_campaign(
        ...
        try:
            ...
            logger.info(f"Sending campaign to {len(contacts)} contacts in segment '{segment}'")
    ...
    def _update_campaign_stats(self, campaign_id: str, sent_count: int, success_count: int) -> None:
